            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="parties_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="partyname" class="col-sm-3 control-label">Name of the Party</label>
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Status</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_status" name="status" required>
                        <option value="" selected id="statusselect"></option>
                        <?php
                          $sql = "SELECT * FROM status";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_assoc()){
