				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
								<img src="images/e_vote.gif" alt="" class="img-responsive center-block" width="250px;">
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										$sql = "SELECT *,party.partyname,party_photo FROM candidates INNER JOIN party ON candidates.party_id = party.id WHERE position_id='".$row['id']."'";
